...
export class SwiperDirective implements OnInit {
  ...
  @Output()
  onSwipeRight: EventEmitter<any> = new EventEmitter<any>();
  @Output()
  onSwipeLeft: EventEmitter<any> = new EventEmitter<any>();
  @Output()
  onSwipeStart: EventEmitter<any> = new EventEmitter<any>();
  @Output()
  onSwipeEnd: EventEmitter<any> = new EventEmitter<any>();
  @Output()
